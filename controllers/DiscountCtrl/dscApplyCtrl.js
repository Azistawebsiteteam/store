...
//   sessionId
// ) => {
//   console.log(discount, 'discount Details');
//   const {
//     min_cart_value,
//     type,
//     code,
...
//     } else {
//       const buyProdutIds = cart.map((p) => p.azst_cart_id);
...
//       if (product_dsc_type === 'percentage') {
...
//   } else {
//     if (method === 'Automatic') {
//       const query = `Delete from azst_cart_tbl where azst_cart_dsc_code = ? `;
//       await db(query, [code]);
//     } else {
